...
[x]: The component you build should be responsive and display correctly across all viewports. 
[x]: It should also be cross-browser compatible and will be tested in Chrome, Firefox, Safari, Internet Explorer 11 and Edge.
[x]: The component includes an active state which is toggled when any part of the component is clicked